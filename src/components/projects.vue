...
<template>
<h1 class="text-center w-screen text-4xl text-white-50" data-aos="zoom-out" data-aos-delay="500" data-aos-duration="1000">Projects</h1>

<div class="w-screen h-max bg-white-950 flex justify-center items-center flex-col z-50">
    
    <div class="h-screen z-50 flex flex-col justify-center items-center overflow-x-hidden">
    ...
    <div class="h-screen w-screen z-50 flex flex-col  items-center overflow-x-hidden">
